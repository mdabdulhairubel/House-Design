...
const FloatingWhatsApp: React.FC = () => {
  return (
    <a
      ...
      className="fixed bottom-8 right-8 z-50 bg-green-500 text-white p-4 rounded-full shadow-2xl hover:bg-green-600 transition-all transform hover:scale-110 whatsapp-pulse flex items-center justify-center"
